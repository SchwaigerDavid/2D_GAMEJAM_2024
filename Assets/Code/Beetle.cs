...
public class Beetle : Enemy
{
    ...
    public void attack(GameObject player)
    {
        ...
        SoundManager.Instance.playRandom("beetle_flamethrower/flamethrower_start", 0.15);
        SoundManager.Instance.playRandom("beetle_flamethrower/flamethrower_loop", 0.15);
